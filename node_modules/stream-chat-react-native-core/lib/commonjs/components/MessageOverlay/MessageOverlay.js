...
var MessageOverlayWithContext = function MessageOverlayWithContext(props) {
  ...
  var isMessageAIGenerated = messagesContext == null ? void 0 : messagesContext.isMessageAIGenerated;
            ...
            children: [alignment === 'left' && MessageAvatar && (0, _jsxRuntime.jsx)(MessageAvatar, {
              ...
              children: messagesContext == null ? void 0 : (_messagesContext$mess = messagesContext.messageContentOrder) == null ? void 0 : _messagesContext$mess.map(function (messageContentType, messageContentOrderIndex) {
                switch (messageContentType) {
                  ...
                  case 'ai_text':
                    return (0, _jsxRuntime.jsx)(_StreamingMessageView.StreamingMessageView, {
                      message: message
                    }, "ai_message_text_container_".concat(messageContentOrderIndex));
                  case 'text':
                  default:
                    return otherAttachments != null && otherAttachments.length && otherAttachments[0].actions || isMessageAIGenerated != null && isMessageAIGenerated(message) ? null : (0, _jsxRuntime.jsx)(_MessageTextContainer.MessageTextContainer, {
                      message: message,
                      messageOverlay: true,
