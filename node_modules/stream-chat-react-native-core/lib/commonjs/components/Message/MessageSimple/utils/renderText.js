...
var MarkdownReactiveScrollView = function MarkdownReactiveScrollView(_ref) {
  ...
  var codeBlockReact = function codeBlockReact(node, _, state) {
    ...
    return (0, _jsxRuntime.jsx)(MarkdownReactiveScrollView, {
      children: (0, _jsxRuntime.jsx)(_reactNative.Text, {
        ...
        children: node == null ? void 0 : (_node$content = node.content) == null ? void 0 : _node$content.trim()
      })
    }, state.key);
  };
...
var ListOutput = function ListOutput(_ref5) {
  var node = _ref5.node,
    output = _ref5.output,
    state = _ref5.state,
    styles = _ref5.styles;
...
var MarkdownTable = function MarkdownTable(_ref9) {
  ...
  var content = (0, _react.useMemo)(function () {
    var nodeContent = [node == null ? void 0 : node.header].concat((0, _toConsumableArray2["default"])(node == null ? void 0 : node.cells));
