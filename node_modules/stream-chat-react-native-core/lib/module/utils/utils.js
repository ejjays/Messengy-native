...
var isBouncedMessage = function isBouncedMessage(message) {
  ...
  return message.type === 'error' && (message == null ? void 0 : (_message$moderation_d = message.moderation_details) == null ? void 0 : _message$moderation_d.action) === 'MESSAGE_RESPONSE_ACTION_BOUNCE' || (message == null ? void 0 : (_message$moderation = message.moderation) == null ? void 0 : _message$moderation.action) === 'bounce';
};
