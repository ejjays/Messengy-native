 ...
 */
export declare const withChatContext: <P extends UnknownType, StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(Component: React.ComponentType<P>) => React.ComponentType<Omit<P, "channel" | "isMessageAIGenerated" | "appSettings" | "client" | "connectionRecovering" | "enableOfflineSupport" | "ImageComponent" | "isOnline" | "mutedUsers" | "setActiveChannel" | "resizableCDNHosts">>;
