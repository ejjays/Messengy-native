 ...
 */
export declare const ChannelAvatarWithContext: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Pick<ChannelPreviewProps<StreamChatGenerics>, "channel"> & {
    /**
     * The size of the avatar
     */
    size?: number | undefined;
} & Pick<ChatContextValue, "ImageComponent">) => React.JSX.Element;
